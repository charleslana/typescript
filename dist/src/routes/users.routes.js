...
usersRouter.get('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, connection_1.default('users').select('id', 'name', 'email')];
            case 1:
                users = _a.sent();
...
usersRouter.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, password, passwordHashed, user, newIds;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                newIds = _b.sent();
                return [2 /*return*/, response.json(__assign({ id: newIds[0] }, user))];
        }
    });
}); });
